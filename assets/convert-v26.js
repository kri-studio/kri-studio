    ...
    try{
      ...
      if(cl){
        ...
        if(!cl.querySelector('.cl-tg-cta')){
          ...
          tgc.innerHTML='<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M9.04 15.31 8.9 19.1c.4 0 .58-.17.8-.38l1.92-1.84 3.98 2.92c.73.4 1.25.19 1.45-.68L20.9 5.6c.26-1.08-.39-1.5-1.1-1.24L3.4 10.66c-1.06.41-1.05 1-.18 1.27l4.2 1.31 9.74-6.14c.46-.3.88-.14.53.16l-8.65 8.05z" fill="#fff"/></svg>Написать в Telegram — быстрее';
          cl.appendChild(tgc);
        }
      }
